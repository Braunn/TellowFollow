# This file looks to emulate the tutorial found here:
# https://www.pyimagesearch.com/2015/09/14/ball-tracking-with-opencv/
# Once working the code will be implemented with tello
# Then the tracking line will be used to keep tello positioned correctly
...
while True:
	...
	frame = vs.read() # WHEN STREAM gives frame WHEN VIDEO gives (bool if frame is read, frame)
	...
	mask = cv2.inRange(hsv, greenLower, greenUpper) # mask out everything that is blue
